...
export interface LabReviewFormProps {
  submissionId: string
  /** Renders a back-to-assignment nav button when provided (used by the standalone route). */
  onBack?: (assignmentId: string) => void
}

export function LabReviewForm({ submissionId, onBack }: LabReviewFormProps) {
