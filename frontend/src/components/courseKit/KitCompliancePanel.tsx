...
import { useCourseKitCompliance } from '@/hooks/courseKit'

interface Props {
  kitId: string
}

export function KitCompliancePanel({ kitId }: Props) {
  const { data, isLoading, isError, refetch, isFetching } = useCourseKitCompliance(kitId)
