...
import {
  ArrowLeft, BookOpen, FileText, Video, Loader2,
...
function DocumentRow({ doc, onOpen }: { doc: ResearchDocument; onOpen: () => void }) {
  return (
    <button
      type="button"
      onClick={onOpen}
...
function VivaRow({ viva, onOpen }: { viva: VivaSession; onOpen: () => void }) {
  return (
    <button
      type="button"
      onClick={onOpen}
...
export default function ResearchProblemDetailPage() {
  ...
  if (isLoading) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-16 flex items-center gap-3 text-gray-500">
