...
class AuditEventType(str, enum.Enum):
    ...
    SYLLABUS_RESUBMITTED         = "SYLLABUS_RESUBMITTED"
    ...
    # Course Kit — M03 quizlets (legacy — MCQ generation/CRUD removed; kept so
    # historical audit log rows predating the removal still deserialize)
    ...
    # Course Kit — M03 faculty-uploaded resources
    COURSE_KIT_RESOURCE_UPLOADED = "COURSE_KIT_RESOURCE_UPLOADED"
    COURSE_KIT_RESOURCE_DELETED  = "COURSE_KIT_RESOURCE_DELETED"
    ...
    # Faculty uploads an externally-edited deck / replaces / deletes an export
    COURSE_KIT_EXPORT_UPLOADED  = "COURSE_KIT_EXPORT_UPLOADED"
    COURSE_KIT_EXPORT_DELETED   = "COURSE_KIT_EXPORT_DELETED"
    ...
    # Assignments — M04 coursework assignment lifecycle (theory/essay/report,
    # separate from M06 Labs and from the M09.6 evaluator-allocation
    # "Assignment Engine" above — prefixed COURSEWORK_ to avoid collision).
    COURSEWORK_ASSIGNMENT_CREATED   = "COURSEWORK_ASSIGNMENT_CREATED"
    COURSEWORK_ASSIGNMENT_UPDATED   = "COURSEWORK_ASSIGNMENT_UPDATED"
    COURSEWORK_ASSIGNMENT_PUBLISHED = "COURSEWORK_ASSIGNMENT_PUBLISHED"
    COURSEWORK_ASSIGNMENT_CLOSED    = "COURSEWORK_ASSIGNMENT_CLOSED"
    COURSEWORK_ASSIGNMENT_DELETED   = "COURSEWORK_ASSIGNMENT_DELETED"
    COURSEWORK_ASSIGNMENT_ARCHIVED  = "COURSEWORK_ASSIGNMENT_ARCHIVED"
    COURSEWORK_ASSIGNMENT_RESTORED  = "COURSEWORK_ASSIGNMENT_RESTORED"
    COURSEWORK_MARKS_RELEASED       = "COURSEWORK_MARKS_RELEASED"
    # Evaluation hand-off: faculty → department → evaluator → ratified marks.
    COURSEWORK_ASSIGNMENT_SUBMITTED = "COURSEWORK_ASSIGNMENT_SUBMITTED"
    COURSEWORK_EVALUATOR_ASSIGNED   = "COURSEWORK_EVALUATOR_ASSIGNED"
    COURSEWORK_MARKS_FINALIZED      = "COURSEWORK_MARKS_FINALIZED"

    # Assignments — M04 submission lifecycle
    COURSEWORK_SUBMISSION_RECEIVED = "COURSEWORK_SUBMISSION_RECEIVED"
    COURSEWORK_SUBMISSION_GRADED   = "COURSEWORK_SUBMISSION_GRADED"
    COURSEWORK_SUBMISSION_RETURNED = "COURSEWORK_SUBMISSION_RETURNED"
    # Coursework AI evaluation (advisory background pipeline)
    COURSEWORK_AI_EVAL_QUEUED      = "COURSEWORK_AI_EVAL_QUEUED"
    COURSEWORK_AI_EVAL_COMPLETED   = "COURSEWORK_AI_EVAL_COMPLETED"
    COURSEWORK_AI_EVAL_FAILED      = "COURSEWORK_AI_EVAL_FAILED"
    ...
    # Faculty Program Assignment — ERP Onboarding Phase 1 / Step 3
